            ...
            <div class="panel-body">
                <ul class="nav nav-tabs" role="tablist">
                    <li class="nav-item active">
                        <a href="#invoice-tab" data-toggle="tab" role="tab" class="nav-link">Invoice</a>
                    </li>
                    <li class="nav-item">
...
@push('js')
    ...
    <script type="text/javascript">
        $(document).ready(function(evt) {
            ...
            let b = $(this),
                url = '{{ route('payment-notification.create') }}';
            vAjax(b.find('i'), {
                url: url,
                done: function(res) {
            ...
            let b = $(this),
                url = '{{ route('payment-notification.edit', ['payment_notification' => ':id']) }}';
