        ...
        <div>
            ...
            <table style="font-family: Arial;Font-size: 12pt;">
                                <tr>
                                    ...
                                    <td><b>{{ $title.' '.$fullname }}</b></td></tr>
                                <tr><td>&nbsp;</td><td><b>{{ $country }}</b></td></tr>
                                <tr><td>&nbsp;</td><td><b>{{ $affiliation }}</b></td></tr>
                        </table>
            <p style="margin-bottom: 0pt; text-align: justify; line-height: 150%;"><span style="font-family: Arial;">Details of payment are as follow.</span></p>
            <table
                cellspacing="0"
                cellpadding="0"
                class="TableGrid"
                style="width: 503.75pt; margin-bottom: 0pt; border: 0.75pt solid #000000; -aw-border: 0.5pt single; -aw-border-insideh: 0.5pt single #000000; -aw-border-insidev: 0.5pt single #000000; border-collapse: collapse;"
            >
                <tr>
                    <td
                        style="
                        ...
                        "
                    >
                        <p style="margin-top: 6pt; margin-bottom: 0pt; line-height: 150%; font-size: 11pt;"><span style="font-family: Arial; font-weight: bold;">No.</span></p>
                    </td>
                    <td
                        style="
                            width: 365.1pt;
                        ...
                        "
                    >
                        <p style="margin-top: 6pt; margin-bottom: 0pt; text-align: center; line-height: 150%; font-size: 11pt;"><span style="font-family: Arial; font-weight: bold;">Payment</span></p>
                    </td>
                    <td
                        style="
                            width: 81.3pt;
                        ...
                        "
                    >
                        <p style="margin-top: 6pt; margin-bottom: 0pt; text-align: center; line-height: 150%; font-size: 11pt;"><span style="font-family: Arial; font-weight: bold;">Fee </span></p>
                    </td>
                </tr>
                <tr>
                    <td
                        ...
                        "
                    >
                        <p style="margin-top: 6pt; margin-bottom: 0pt; line-height: 150%; font-size: 11pt;"><span style="font-family: Arial;">1.</span></p>
                    </td>
                    <td
                        style="
                            width: 365.1pt;
                        ...
                        "
                    >
                        <p style="margin-top: 6pt; margin-left: 2.05pt; margin-bottom: 0pt; text-indent: -0.5pt; line-height: 150%; font-size: 11pt;">
                            <span style="font-family: Arial;">Registration fee as </span><span style="font-family: Arial; font-weight: bold;">{{ $role }}</span>
                        </p>
                        <table>
                    ...
                    <td
                        ...
                        "
                    >
                        <p style="margin-top: 6pt; margin-bottom: 0pt; text-align: center; line-height: 150%; font-size: 11pt;"><span style="font-family: Arial; font-weight: bold;">{{ $nominal }}</span></p>
                    </td>
                </tr>
            </table>
            ...
            <p style="margin-bottom: 0pt; line-height: 125%;">
                ...
                <a href="mailto:lusi.safriani@phys.unpad.ac.id" style="text-decoration: none;"><span class="Hyperlink" style="font-family: Arial; font-weight: bold;">lusi.safriani@phys.unpad.ac.id</span></a>
            </p>
