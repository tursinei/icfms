<html>
    ...
    <body>
        <div>
            ...
            <p style="margin-bottom: 0pt; text-align: justify; line-height: 150%;"><span style="font-family: Arial;">Details of payment for accommodation at Prama Sanur Beach Bali Hotel, Bali, Indonesia are as follows.</span></p>
            <table
                cellspacing="0"
                id = "tableInfo"
                cellpadding="0"
            ...
            >
                ...
                <tr><th colspan="5">Grand Total ({{ $currency }})</th><th>{{ $nominal }}</th></tr>
            </table>
